            ...
            <div class="col-8">
              <div class="card-body">
                ...
                <p class="card-text" style="line-height:20px;"><?= substr($posting['isi_posting'],0,50).'...'; ?> <a href="<?= base_url('detail/'.$posting['url_posting'].'/'); ?>">selengkapnya</a> <br>
                  ...
                  <span class="fs-0"><i class="bi bi-eye-fill text-primary"></i> <?= $posting['visitor_posting']; ?>x</span>
                  </div>
                </p>
            ...
            <div class="col-8">
              <div class="card-body">
                ...
                <p class="card-text" style="line-height:20px;"><a href="#"></a>
                  <div class="d-flex justify-content-start" style="margin-top:-10px;color:#aaa;font-size:15px">
                  <span class="fs-0 me-4"><i class="bi bi-clock-fill text-primary"></i> 
                    <?php 
