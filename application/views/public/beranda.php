    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark text-light shadow-sm" style="background-color:#32a89d">
      <div class="container-fluid">
        <!-- <a class="navbar-brand" href="<?= base_url(); ?>">Mata code (<?= $totalvisitor+1; ?>)</a> -->
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item d-flex justify-content-between align-items-center" href="<?= base_url('admin/ubahpassword'); ?>">Ubah Password</a></li>
                  <li><a class="dropdown-item d-flex justify-content-between align-items-center" href="<?= base_url('auth/logout'); ?>">Keluar</a></li>
              </ul>
            </li>
            <?php } ?>
          </ul>
    ...
    <!-- jumbotron -->
    <div class="jumbotron jumbotron-fluid text-dark text-center rounded p-4 shadow-sm" style="background-color:rgba(85, 217, 204,.8);margin-top:55px;">
      <div class="container">
        <h2>Selamat Datang Di</h2>
        <h1 class="display-4" style="font-weight:bold;">MATA CODE</h1>
        <p class="lead">Temukan solusi untuk masalah script dan code program web anda Disini</p>
      </div>
    </div>
    <!-- tutup jumbotron -->
...
<?php if($this->session->userdata('level_user')){ ?>
    ...
    <a class="btn btn-primary position-fixed bottom-0 end-0 m-4" type="button">
      <i class="bi bi-bell-fill fs-0" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample"></i>
      <?php if($countnotifikasi!=0){ ?>
      <span class="position-absolute top-0 start-100 translate-middle badge bg-danger rounded-pill bg-secondary">+<?= $countnotifikasi; ?></span>
      <?php } ?>
    </a>
      ...
      <div class="offcanvas-body">
        ...
        <div style="margin-top:-10px;">
          <div class="list-group">
            ...
            <?php if($notifikasi['level_komentar']=='users'){ ?>
            <a href="<?= base_url('detail/'.$notifikasi['url_posting']); ?>" class="list-group-item list-group-item-action" style="border-left:0;border-right:0;<?php if($notifikasi['status_komentar']=='belum'){ echo "background-color:#e0fffc;"; } ?>" aria-current="true">
              <div class="d-flex w-100 justify-content-between">
                <h5 class="mb-0"><?= $notifikasi['nama_komentar']; ?></h5>
                <small>
                  <?php 
                    $waktu=time()-$notifikasi['tanggal_komentar'];
                    if($waktu<60){
                      echo $waktu.' detik lalu';
                    }else if($waktu>=60&&$waktu<=3600){
                      $waktumenit=$waktu/60;
              ...
              <small><?= substr($notifikasi['isi_komentar'],0,40).'...'; ?></small>
            </a>
            <?php } ?>
            <?php endforeach; ?>
          </div>
