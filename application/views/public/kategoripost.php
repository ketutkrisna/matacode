    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark text-light shadow-sm" style="background-color:#32a89d">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex" method="post" action="<?= base_url('caridata/'.$this->uri->segment(2)); ?>">
    ...
    <div class="row ms-1 me-1">
      <?php if($countcari==0){ ?>
        <p class="text-center">Tidak ada hasil untuk kata kunci "<span class="text-danger"><?= set_value('cariberanda'); ?></span>"  pada kategori <span class="text-danger">"<?= $this->uri->segment(2); ?>"</span>!</p>
      <?php }else{ ?>
